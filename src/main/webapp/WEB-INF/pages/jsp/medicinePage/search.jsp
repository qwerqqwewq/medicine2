      ...
      <table class="table-box1">
        ...
        <c:forEach items="${medicines}" var="medicine">
          <tr>
            ...
            <td>${medicine.kindByKindCode.kindCode}</td>
            <td>${medicine.firmByFirmCode.firmCode}</td>
            <td>${medicine.firstDate}</td>
            <td>${medicine.usefullDate}</td>
            <td>
              <a href="${pageContext.request.contextPath}/medicine_detailInf.action?MedicineCode=${medicine.medicineCode}">查询详情</a>
