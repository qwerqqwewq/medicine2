...
<form method="post" action="${pageContext.request.contextPath}/firm_addFirm.action">
  <div class="box">
    <div>
        <h2>供应商信息</h2>
    </div>
    ...
    <div>
        <input type="text" placeholder="供应商名称" name="FirmName">
    </div>
    <div>
        <input type="text" placeholder="联系人" name="Link">
    </div>
    <div>
        <input type="text" placeholder="联系电话" name="LinkTel">
    </div>
    <div>
